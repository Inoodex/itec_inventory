...
<style>
    ...
    .badge-soft-primary:hover {
        background-color: rgba(118, 56, 255, 0.25) !important;
        color: #4c1d95 !important;
        box-shadow: 0 0 0 3px rgba(118, 56, 255, 0.15);
    }
    .btn-action-icon {
        width: 32px;
        height: 32px;
    ...
    <div class="card border-0 shadow-sm rounded-3">
        ...
        <div class="card-body p-0" style="overflow: visible;">
            <div class="table-responsive">
                <table class="table table-custom align-middle mb-0" id="rolesTable">
